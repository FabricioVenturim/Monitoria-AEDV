...
O camminho para criar um arquivo R markdown é: `File > New File > R Markdown`.
...
Aqui vocês irão configurar o estilo e propriedades do HTML que será gerado. Deixo dois sites se quiser personalizar do seu jeito o HTML:
